...
--Do not forget to put NodeMCU 14 at least to have a sleeping time > 30min
...
function listap(t) --scan the network to find Bridge
...
tmr.alarm(0,3600000,1, function()
    ...
    if listap(t) then 
            ...
            file.close()
     else rtctime.dsleep(3598*1000000) --sleeping for an hour - 2s

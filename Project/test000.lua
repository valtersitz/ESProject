...
print("At the very very begining heap is:"..node.heap())
myNode=0
...
tmr.alarm(4,10000,1, function() 
    ...
    else print(numAvNode.."nodes have been detected")
    --end
    print(avNode[numAvNode])
    numAvNode=0
      tmr.stop(4)
      tmr.alarm(0,1000,1,
        function()
            ...
            tmr.alarm(1,8000,1,
                function()
                    ...
                    if nearestNode==nil then
                        ...
                        print("entering hell")
                        sta_ssid = "ESP0_1" --numberNodes -- your router SSID you want to connect to
